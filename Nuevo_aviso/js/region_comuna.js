...
function updateComunas() {
    const selectedNumero = parseInt(regionSelect.value);
    comunaSelect.innerHTML = '<option value="">Seleccione una comuna</option>'; 

    const region = region_comuna.regiones.find(r => r.numero === selectedNumero);
    if (region) {
...
document.addEventListener("DOMContentLoaded", displayRegiones);
